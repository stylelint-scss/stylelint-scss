...
export const ruleName = namespace("declaration-nested-properties-no-divided-groups")

export const messages = utils.ruleMessages(ruleName, {
  expected: (prop) => `Expected all nested properties of "${prop}" namespace to be in one nested group`,
})
  ...
  return (root, result) => {
    ...
    root.walk(item => {
      ...
      Object.keys(nestedGroups).forEach(namespace => {
        ...
        if (nestedGroups[namespace].length === 1) { return }
