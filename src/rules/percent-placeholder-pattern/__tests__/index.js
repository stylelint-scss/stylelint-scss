...
testRule(rule, {
  ...
  accept: [ {
    ...
    code: " %foo { top: 1em; }",
    description: "Regexp: sequence part. Example: extra space after before placeholder selector.",
  }, {
    code: ".fowdo { top: 1em; }",
...
testRule(rule, {
  ...
  reject: [ {
    ...
    description: "Regexp: strict match. Example: matches, but has a space after '%'.",
  }, {
    code: "%food { top: 1em; }",
    line: 1,
...
testRule(rule, {
  ...
  accept: [ {
    ...
    description: "Regexp: SUIT component. Example: comply, nesting, both levels comply.",
  }, {
    code: ".cd { @media print { #de { & + .fg {} } } }",
    description: "Regexp: SUIT component. Example: no placeholder, should skip.",
  } ],
  ...
  reject: [ {
    ...
    description: "Regexp: SUIT component. Example: nesting, only lv1 part comply.",
  }, {
    code: `%Fo {
      &o-bar {
        color: red;
