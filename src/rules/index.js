...
const commentNoEmpty = require("./comment-no-empty").rule;
...
const dollarVariableEmptyLineAfter = require("./dollar-variable-empty-line-after")
  .rule;
const dollarVariableEmptyLineBefore = require("./dollar-variable-empty-line-before")
  .rule;
const dollarVariableFirstInBlock = require("./dollar-variable-first-in-block")
  .rule;
...
const noGlobalFunctionNames = require("./no-global-function-names").rule;
