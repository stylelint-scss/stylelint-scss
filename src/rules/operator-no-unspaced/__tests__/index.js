...
testRule(rule, {
  ...
  accept: [ {
    ...
    code: "a { a5: s.1px -1px; }",
    description: "List (actually, it gets calculated, but only if with the `s` appendix...): s.1px -1px.",
  } ],
...
testRule(rule, {
  ...
  reject: [ {
    ...
    code: "a { width: 8px/2- ss }",
    description: "- does concatenate, so warning. But it's not a math op, so doesn't /: 8px/2- ss.",
    message: messages.expectedBefore("-"),
    column: 17,
  } ],
})
...
testRule(rule, {
  ...
  accept: [ {
    ...
    `,
    description: "operator-newline-indentation (spaces)-operand: 1 -\\n          a.",
  }, {
    code: `
      a {
        width: 1 -
...
- 1;
  ...
  reject: [ {
    ...
    `,
    description: "Operator-spaces-newline-indentation-operand and a breaching operator: 1 -  \\na+ 1.",
    line: 5,
    column: 12,
  }, {
    code: "a { width: 1 -  1; }",
...
testRule(rule, {
  ...
  reject: [ {
    ...
    description: "Interpolation in a selector (second in a list): .#id, class#{1 +1}name.",
    message: messages.expectedAfter("+"),
    column: 16,
  }, {
    code: `
    ...
    `,
    description: "Interpolation in selector, newline and indentation before: .class#{1 +1}name.",
    line: 2,
    column: 17,
    message: messages.expectedAfter("+"),
  }, {
...
testRule(rule, {
  ...
  reject: [ {
    ...
    `,
    description: "Media type as interpolation: @media #{'scr' +'en'} and (color).",
    line: 2,
    column: 22,
    message: messages.expectedAfter("+"),
  }, {
    ...
    `,
    description: "Media type as interpolation, newlines messed: @media #{'scr' +'en'} and (color).",
    line: 2,
    column: 15,
    message: messages.expectedAfter("+"),
  }, {
    ...
    `,
    description: "Media feature expression: @media (#{'max' +'-width': 100px}).",
    line: 2,
    column: 24,
    message: messages.expectedAfter("+"),
  }, {
    ...
    `,
    description: "Value of a non-first media feature: @media (min-width: 10px), (max-width: 100px +1).",
    line: 2,
    column: 51,
    message: messages.expectedAfter("+"),
  } ],
...
testRule(rule, {
  ...
  reject: [ {
    ...
    `,
    description: "Function definition, param default (usual breach): @function fn ($a: 10px+ 1).",
    line: 2,
    column: 29,
    message: messages.expectedBefore("+"),
  }, {
    code: `
      @function fn ($a: 10px +1) {};
    `,
    description: "Function definition, param default (special breach): @function fn ($a: 10px +1).",
    line: 2,
    column: 30,
    message: messages.expectedAfter("+"),
  }, {
    ...
    `,
    description: "Function definition, param default (special breach): @function fn ($b, $a: 10px +1).",
    line: 2,
    column: 43,
    message: messages.expectedAfter("+"),
  } ],
