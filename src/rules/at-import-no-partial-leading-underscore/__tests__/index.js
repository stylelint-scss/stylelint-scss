...
testRule(rule, {
  ...
  accept: [ {
    ...
    code: `
      @import "_path/fff";
    `,
    description: "One file, path with a dir, underscore in dir name, double quotes.",
  }, {
    code: `
  ...
  reject: [ {
    ...
    line: 2,
    message: messages.expected,
    description: "One file, underscore at the start, trailing space at the end.",
  }, {
    code: `
      @import " _fff";
    `,
    line: 2,
    message: messages.expected,
    description: "One file, underscore at the start, trailing space at the start.",
  }, {
    code: `
      @import "df/_fff";
    `,
