...
test("Import a file from a partial .scss 2", () => {
  return new Promise(done => {
    expect.assertions(1);
    postcss([rule()])
      .process('@import "file.scss";', {
...
test("Ignores empty imports (Sass will throw an error instead)", () => {
  return new Promise(done => {
    expect.assertions(1);
    postcss([rule()])
      .process("@import '';", {
...
test("Ignores empty imports (Sass will throw an error instead) 2", () => {
  return new Promise(done => {
    expect.assertions(1);
    postcss([rule()])
      .process('@import " ";', {
...
test("Import comma separated files from a partial .scss; omitting extension", () => {
  return new Promise(done => {
    expect.assertions(1);
    postcss([rule()])
...
test("Import comma separated files from a partial .scss; omitting extension 2", () => {
  return new Promise(done => {
    expect.assertions(1);
    postcss([rule()])
      .process('@import "file" , "file2";', {
...
test("Import a CSS file (font URL with https) from a partial .scss", () => {
  return new Promise(done => {
    expect.assertions(1);
    postcss([rule()])
      .process(
...
test("Import a local file and a CSS file (font URL with https) from a partial .scss (warn for local file, but not https import)", () => {
  return new Promise(done => {
    expect.assertions(1);
    postcss([rule()])
      .process(
...
test("Import a local file and a CSS file (font URL with https) from a partial .scss (warn for local file, but not https import) 2", () => {
  return new Promise(done => {
    expect.assertions(1);
    postcss([rule()])
      .process(
...
test("Import a local file and a CSS file (font URL with https) from a partial .scss (warn for local file, but not https import) 3", () => {
  return new Promise(done => {
    expect.assertions(1);
    postcss([rule()])
      .process(
